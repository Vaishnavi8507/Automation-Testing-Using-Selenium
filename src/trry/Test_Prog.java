...
public class Test_Prog {
    ...
    public void login() throws Exception {
        try {
            ...
            String phone = inputSheet.getCell(1, 0).getContents();
            ...
            writeToExcel("Entered phone number: " + phone, "Pass");
            ...
            // Increase wait time after searching the keyword
            ...
            WebElement firstProductLink = wait.until(ExpectedConditions.presenceOfElementLocated(
                By.xpath("//a[@href='/rich-black-chinos-for]")
            ));
    ...
    private void selectSizeAndAddToCart() throws Exception {
        ...
        // Increase wait time after selecting the size
        Thread.sleep(10000);  // Increased to 10 seconds
